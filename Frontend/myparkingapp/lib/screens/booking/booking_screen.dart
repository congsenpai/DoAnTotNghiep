...
import 'package:myparkingapp/components/auto_complete_dropdown.dart';
...
class BookingScreen extends StatefulWidget {
  ...
  const BookingScreen({super.key, required this.lot, required this.slot, required this.token});
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void initState() {
    ...
    context.read<BookingBloc>().add(BookingInitialEvent(widget.token, widget.lot));
  }
